...
## Aim
To perform Pulse Code Modulation (PCM) on an analog signal and visualize the message signal, clock signal, quantized signal, and demodulated signal.
...
## Results
The Pulse Code Modulation (PCM) process was successfully performed on an analog signal. The quantized signal closely follows the original message signal, demonstrating effective PCM encoding and visualization.
